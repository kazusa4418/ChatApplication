...
public class StatementsTest extends BaseTestCase {
    ...
    /**
     * Test for (ServerAccessManager)PreparedStatement.executeLargeBatch().
     * Validate update count returned and generated keys.
     */
    ...
    /**
     * Test for (ServerAccessManager)PreparedStatement.setObject().
     * Validate new methods as well as support for the types java.time.Local[Date][Time] and java.time.Offset[Date]Time.
     */
    ...
    /**
     * Test for (ServerAccessManager)PreparedStatement.setObject(), unsupported SQL types TIME_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE and REF_CURSOR.
     */
